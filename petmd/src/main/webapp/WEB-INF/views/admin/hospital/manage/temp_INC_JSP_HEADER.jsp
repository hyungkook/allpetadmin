...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<script src="${con.JSPATH}/jquery.mobile-1.2.0.min.js?v=1402180"></script>​
	
	<link rel="stylesheet" href="${con.CSSPATH}/common2.css?v=1402180" type="text/css"/>
	<link rel="stylesheet" href="${con.CSSPATH}/style2.css?v=1402180" type="text/css"/>
