...
<c:set var="pre_data" value="${pre_data}/${fn:replace(fn:replace(boardContents.s_contents,lf,'\\\n'),quot,equot)}"/>
		...
		<div data-role="content" id="contents">
			...
			<c:if test="${empty params.view_type}">
				...
				<div class="view_contents">
					...
					<p class="txt02">${fn:replace(fn:replace(boardContents.s_contents,'<','&lt;'),lf,'<br/>')}</p>
			...
			<c:if test="${not empty params.view_type}">
				...
				<div class="a_type02_b">
					<h3 class="red"><img src="${con.IMGPATH}/common/bu_replay.png" alt="" width="5" height="5"/>답변내용</h3>
