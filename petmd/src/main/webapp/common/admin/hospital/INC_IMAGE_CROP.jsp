...
<div id="poparea02" style="display:none;z-index:99999;">
	...
	<!-- head 시작-->
	<div id="p02_head">
		<p class="btn_head"><a onclick="cropClose()" data-role="button"><img src="${con.IMGPATH_OLD}/btn/btn_pop_close.png" alt="" width="19" height="19"/></a></p>
	</div>
	<!-- //head 끝-->
	...
	<div id="p02_bottom">
		<div class="pop_btn_area">
			...
			<p class="pop_btn_type01"><a onclick="expansion(2);" data-role="button"><img src="${con.IMGPATH_OLD}/btn/btn_expand.png" alt="" width="16" height="16"/> 확대</a></p>
			<p class="pop_btn_type01"><a onclick="reduce(2);" data-role="button"><img src="${con.IMGPATH_OLD}/btn/btn_cont.png" alt="" width="16" height="16"/> 축소</a></p>
			<p class="pop_btn_type02"><a id="cropStartBtn" onclick="cropStart();" data-role="button"><img src="${con.IMGPATH_OLD}/btn/btn_cut.png" alt="" width="16" height="16"/> 잘라내기</a></p>
		</div>
	</div>
	<!-- //content 끝-->
